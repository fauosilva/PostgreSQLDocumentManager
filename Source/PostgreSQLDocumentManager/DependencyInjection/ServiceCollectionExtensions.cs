...
namespace PostgreSQLDocumentManager.DependencyInjection
{
    public static class ServiceCollectionExtensions
    {
        ...
        {            
            ...
            serviceCollection.AddScoped<IUserGroupRepository, UserGroupsRepository>();
            ...
            serviceCollection.AddScoped<IDocumentPermissionRepository, DocumentPermissionRepository>();
        }
